...
import { DroneStatus, GeofenceObjectType, ThreatType, Location, AIAction } from './types';
...
function App() {
    ...
    }, [getStatus, getAnomalies, getThreats, getAIActionRequests, getAITargetDesignations, getFlightSuggestions, getUFOs, getEliminationEvents, isReplayMode]);
