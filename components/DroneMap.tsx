...
import { DroneStatus, type Drones, type Location, type FlightPaths, type Anomaly, type Threat, type Drone, type FlightPath, type DroneNicknames, type Geofence, UnidentifiedFlyingObject, GeofenceEvent, UFOType, ThreatType, AITargetDesignationRequest, EliminationEvent } from '../types';
